...
class ParallelCoordsConan(ConanFile):
    ...
    """
    name = "ParallelCoordinatesPlugin"
    description = ("A parallel coordinates plugin for HDPS. "
                   "Based on the d3.js library Parallel Coordinates. ")
    topics = ("hdps", "plugin", "data", "parallel coordinates")
    url = "https://github.com/hdps/ParallelCoordinatesPlugin"
    ...
    def _configure_cmake(self, build_type):
        ...
        cmake.configure(source_folder="hdps/ParallelCoordinatesPlugin")
        cmake.verbose = True
        return cmake
    ...
    def build(self):
        ...
        # The ParallelCoordinatesPlugin build expects the HDPS package to be in this install dir
